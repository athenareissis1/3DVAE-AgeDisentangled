...
class SwapFeatures:
    ...
    def __call__(self, batched_data):
        ...
        norm_age_batch = batched_data.norm_age
        fname_batch = batched_data.fname
        ...
        batched_data = Data(x=new_batch, swapped=key, age=age_batch, norm_age=norm_age_batch, fname=fname_batch)
        return batched_data
